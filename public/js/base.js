<div class="col-xs-12 col-md-10 col-md-offset-1 col-md-8 col-md-offset-2 col-lg-6 col-lg-offset-3">
    ...
    <form class="form-inline">
        <div class="form-group" ng-init='vm.constructor($ville)'>
            ...
            <input type="text" class="form-control" placeholder="Ville d'origine" id='ville{{$ville}}' ng-model='vm.todo.villeOrigine'>
